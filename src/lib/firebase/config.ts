...
const firebaseConfig = {
  ...
  // tenant/PM's auth state stops responding.
  // Requires https://resigrid.co/__/auth/handler to be listed under
  // Authorized redirect URIs on the OAuth 2.0 client in Google Cloud Console
  // (APIs & Services -> Credentials) — done as of this change; otherwise
  // Google rejects sign-in with "Error 400: redirect_uri_mismatch".
