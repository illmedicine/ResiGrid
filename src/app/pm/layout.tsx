...
import { Building2, ClipboardList, FileText, Home, LayoutList, MessageSquare, Users, Wrench } from "lucide-react";
...
const navItems: PortalNavItem[] = [
  ...
  { href: "/pm/applications", label: "Applications", icon: ClipboardList },
